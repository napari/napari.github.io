...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    no earlier than v0.10.0. It is considered an "implementation detail" of the napari
    application, not part of the napari viewer model. If your use case
    requires access to qt_viewer, please open an issue to discuss.
      layer_buttons = viewer.window.qt_viewer.layerButtons
    calling <function bind_shortcut at 0x7fdcdcea8b80>
    calling <function register_action at 0x7fdcdceaab60>
    calling <function bind_button at 0x7fdcdcea8cc0>
