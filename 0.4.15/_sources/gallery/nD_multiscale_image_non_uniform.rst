...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /opt/miniconda/envs/napari-dev/lib/python3.9/site-packages/skimage/io/_plugins/imageio_plugin.py:10: DeprecationWarning: Starting with ImageIO v3 the behavior of this function will switch to that of iio.v3.imread. To keep the current behavior (and make this warning dissapear) use `import imageio.v2 as imageio` or call `imageio.v2.imread` directly.
      return np.asarray(imageio_imread(*args, **kwargs))
    /home/melissa/projects/napari/examples/nD_multiscale_image_non_uniform.py:18: FutureWarning: `multichannel` is a deprecated argument name for `pyramid_gaussian`. It will be removed in version 1.0. Please use `channel_axis` instead.
    ...
    /opt/miniconda/envs/napari-dev/lib/python3.9/site-packages/vispy/gloo/glir.py:853: DeprecationWarning: distutils Version classes are deprecated. Use packaging.version instead.
      elif LooseVersion(this_version) < '2.1':
    /opt/miniconda/envs/napari-dev/lib/python3.9/site-packages/setuptools/_distutils/version.py:351: DeprecationWarning: distutils Version classes are deprecated. Use packaging.version instead.
