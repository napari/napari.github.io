...
{% include image.html url="./resources/dask1.gif" description="mCherry-H2B showing chromosome separation during mitosis. Collected on a lattice light sheet microscope" %}
