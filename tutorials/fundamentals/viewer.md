...
adding images to the viewer see the [Image layer](../../howtos/layers/image) 
tutorial. Now we will continue exploring the rest of the viewer.
...
**napari** supports checkout some more of our tutorials listed below. The
[Using layers](../../howto/layers/index) guide is a great one to try next as
viewing images and exploring different layers is a fundamental part of what
**napari** is about.
