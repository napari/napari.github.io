...
- Add points/shapes highlight color setting to Appearance settings and preference page ([#6689](https://github.com/napari/napari/pull/6689))
...
- Fix conda availability check ([#5496](https://github.com/napari/napari/pull/5496))
...
- Add additional guard at the end of `test_worker_may_exceed_total` ([#5781](https://github.com/napari/napari/pull/5781))
...
- Re-add exception to event proxy ([#5797](https://github.com/napari/napari/pull/5797))
...
- Fix link to artifacts in update dependencies comment ([#6270](https://github.com/napari/napari/pull/6270))
...
- Add cacheable context mapping ([#6965](https://github.com/napari/napari/pull/6965))
...
- Add documentation of update tokens for automated actions. ([docs#144](https://github.com/napari/docs/pull/144))
...
- Dynamically calculate supported python version range ([docs#368](https://github.com/napari/docs/pull/368))
...
- Include docstring of `make_napari_viewer` in `testing.md` ([docs#378](https://github.com/napari/docs/pull/378))
...
- Use `GITHUB_TOKEN` to create test dependencies PR ([#5774](https://github.com/napari/napari/pull/5774))
- Use fine grained personal token for test constraints and vendored update ([#5777](https://github.com/napari/napari/pull/5777))
...
- Update typing information in `_app_model/injection/_processors.py` and `components/layerlist.py` ([#6153](https://github.com/napari/napari/pull/6153))
...
- Remove an "if" that prevents proper run of "upgrade dependencies" wokflow if triggered by comment ([#6171](https://github.com/napari/napari/pull/6171))
...
- Remove sphinx dependency from defaults dependencies ([#6239](https://github.com/napari/napari/pull/6239))
...
- Add pre-commit check for basic formatting bugs ([#6315](https://github.com/napari/napari/pull/6315))
...
- Add codecov token to reduce probability of fail to upload from main branch ([#6346](https://github.com/napari/napari/pull/6346))
...
- Automatic add `maintenance` label to upgrade dependencies workflow ([#6371](https://github.com/napari/napari/pull/6371))
...
- add additional pystack arguments ([#6457](https://github.com/napari/napari/pull/6457))
...
- use cross group dependency in pyproject.toml ([#6720](https://github.com/napari/napari/pull/6720))
...
- Allow to use "remove ready to merge label" and "edit PR description" callable from another repository ([#6839](https://github.com/napari/napari/pull/6839))
...
- Fix citation cff and add workflow for future validation ([#6888](https://github.com/napari/napari/pull/6888))
...
- Fix and simplify release workflow ([#7078](https://github.com/napari/napari/pull/7078))
